      ...
      <section className="border-t border-shell/10">
        <div className="mx-auto max-w-3xl space-y-6 px-6 py-20 text-shell/80">
          <p>
            ...
            across it as a wellness product long before he understood it as
            a beverage tradition. Two years earlier, in 2013, he&apos;d
            trained under Julian Cox — at the time, LA&apos;s top mixologist
            — learning cocktail craft in the city&apos;s best bars.
          </p>
          <p>
            Traditional kava&apos;s flavor is an acquired taste. Etienne saw
            that as the real barrier to it ever going mainstream. So he
          ...
          <p>
            ...
            It&apos;s why Lumanai donates a share of every order to the
            South Pacific Islander Organization, supporting Pacific Islander
            education — 1% today, with plans to grow that as margins allow.
          </p>
        </div>
      </section>
